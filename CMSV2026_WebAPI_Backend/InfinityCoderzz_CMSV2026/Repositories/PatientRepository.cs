...
namespace InfinityCoderzzz_CMSV2026.Repositories
{
    public class PatientRepository : IPatientRepository
    {
        ...
        public void RegisterPatient(Patient patient)
        {
            ...
            cmd.Parameters.AddWithValue("@AadhaarNumber", (object?)patient.AadhaarNumber ?? DBNull.Value);
            cmd.Parameters.AddWithValue("@AlternateMobile", (object?)patient.AlternateMobile ?? DBNull.Value);
            ...
            cmd.Parameters.AddWithValue("@Pincode", (object?)patient.Pincode ?? DBNull.Value);
